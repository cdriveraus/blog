...
```{r echo=FALSE}
ctModelLatex(m,textsize = 'footnotesize',folder = './',filename = 'mdefaulttex',open=FALSE)
system(command = 'pdfcrop mdefaulttex.pdf mdefaulttex2.pdf')
knitr::include_graphics("mdefaulttex2.pdf")
```

<iframe src="https://docs.google.com/gview?url=https://cdriver.netlify.com/post/mdefaulttex2.pdf&embedded=true" style="width:600px; height:800px;" frameborder="0"></iframe>


<img src="/post/mdefaulttex2.pdf">

<object data="/post/mdefaulttex2.pdf" type="application/pdf" width="300" height="200">
<a href="/post/mdefaulttex2.pdf">test.pdf</a>
</object>
So we will use a more restrictive, linear growth model:
