...
```{r echo=FALSE}
ctModelLatex(m,textsize = 'footnotesize',folder = './',filename = 'mdefaulttex')
knitr::include_graphics("./post/mdefaulttex.pdf")
```

<iframe src="https://docs.google.com/gview?url=https://cdriver.netlify.com/post/mdefaulttex.pdf&embedded=true" style="width:600px; height:500px;" frameborder="0"></iframe>


<img src="/post/mdefaulttex.pdf">

<object data="/post/mdefaulttex.pdf" type="application/pdf" width="300" height="200">
